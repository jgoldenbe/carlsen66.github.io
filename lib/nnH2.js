...
class NeuralNetwork {
     ...
     */
    constructor(in_nodes, hid_nodes, hid_nodes2, out_nodes) {
        if (in_nodes instanceof NeuralNetwork) {
            ...
            this.weights_ih2 = a.weights_ih2.copy();
            ...
            this.hidden_nodes = hid_nodes2;
            this.output_nodes = out_nodes;

            this.weights_ih = new Matrix(this.hidden_nodes, this.input_nodes);
            this.weights_ih2 = new Matrix(this.hidden_nodes2, this.hidden_nodes);
            this.weights_ho = new Matrix(this.output_nodes, this.hidden_nodes);
            this.weights_ih.randomize();
            this.weights_ih2.randomize();
    ...
    predict(input_array) {
        ...
        let hidden2 = Matrix.multiply(this.weights_ih2, hidden);
